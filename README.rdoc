...
* [in progress] BBox restriction of imported data
* [in progress] Data reprojection between schemas
...
Database schemas definition goes to Osmfile which contains basic flags and schema definitions:
  ...
  schema :source, :type => :osm2pgsql do # Osm2pgsql schema named 'source'
    ...
    bbox 36.562495, 54.367759, 36.562495, 54.775345 # It has bounding box restriction as minlon, minlat, maxlon, maxlat
